    ...
    <div className=" w-full flex flex-col md:flex-row items-center justify-center gap-4 h-full">
      ...
      <div className="md:w-1/4 flex flex-col items gap-4">
        ...
        <div className=" flex items-center justify-center w-full">
          <Link
            to={"/report"}
            className="text-white w-full bg-nextColor dark:bg-opacity-50 rounded-xl p-2 shadow-xl hover:bg-transparent hover:border hover:border-nextColor hover:bg-gradient-to-l duration-500 ease-in-out from-nextColor"
          >
