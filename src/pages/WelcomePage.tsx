...
const WelcomePage = () => {
  ...
  return (
    <div>
      <div className=" h-screen absolute w-full flex items-end -z-10">
      ...
      {page == 1 && (
        <div className="flex flex-col h-screen items-center justify-center">
          <div className=" flex flex-col items-center">
            <div className=" h-fit w-full px-14 absolute font-bold text-2xl -mt-10">
              <h1>
            ...
            <h1 className=" font-semibold -mt-8 w-full px-8 ">About us</h1>
            <p className=" mx-8 mt-3 font-thin">
